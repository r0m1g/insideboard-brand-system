...
The Brand OS started as a single HTML document (`index.html`) that serves both as a brand reference and as a visual exploration space. As the project matures, these two roles are in tension:
...
- ADR-004 — Port ui-test.html redesign to the Brand OS (prerequisite to this)
